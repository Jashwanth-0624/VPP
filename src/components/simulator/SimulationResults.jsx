          ...
          <CardContent className="p-4 h-full flex items-center">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col justify-center text-center">
                ...
                <p className="text-lg font-bold text-slate-900 whitespace-nowrap">{formatCurrency(Number(results.dailySavings || 0), 'INR')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4 h-full flex items-center">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col justify-center text-center">
                ...
                <p className="text-lg font-bold text-slate-900 whitespace-nowrap">{Number(results.carbonSavings || 0).toFixed(2)}</p>
          ...
          <CardContent className="p-4 h-full flex items-center">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col justify-center text-center">
                ...
                <p className="text-lg font-bold text-slate-900 whitespace-nowrap">{Number(results.renewablePercentage || 0).toFixed(2)}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4 h-full flex items-center">
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex flex-col justify-center text-center">
                ...
                <p className="text-lg font-bold text-slate-900 whitespace-nowrap">{Number(results.gridUsage || 0).toFixed(2)}</p>
